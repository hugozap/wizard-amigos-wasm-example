...
* @returns {Uint8Array}
*/
__exports.add_effect = function(image, width, height) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(image, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.add_effect(retptr, ptr0, len0, width, height);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
__exports.crop = function(photon_image, x1, y1, x2, y2) {
    _assertClass(photon_image, PhotonImage);
    const ret = wasm.crop(photon_image.ptr, x1, y1, x2, y2);
    return PhotonImage.__wrap(ret);
};
...
__exports.resize_img_browser = function(photon_img, width, height, sampling_filter) {
    ...
    const ret = wasm.resize_img_browser(photon_img.ptr, width, height, sampling_filter);
    return takeObject(ret);
};
...
__exports.resize = function(photon_img, width, height, sampling_filter) {
    _assertClass(photon_img, PhotonImage);
    const ret = wasm.resize(photon_img.ptr, width, height, sampling_filter);
    return PhotonImage.__wrap(ret);
};
...
__exports.seam_carve = function(img, width, height) {
    _assertClass(img, PhotonImage);
    const ret = wasm.seam_carve(img.ptr, width, height);
    return PhotonImage.__wrap(ret);
};
...
__exports.padding_uniform = function(img, padding, padding_rgba) {
    ...
    padding_rgba.ptr = 0;
    const ret = wasm.padding_uniform(img.ptr, padding, ptr0);
    return PhotonImage.__wrap(ret);
};
...
__exports.padding_left = function(img, padding, padding_rgba) {
    ...
    var ptr0 = padding_rgba.ptr;
    padding_rgba.ptr = 0;
    const ret = wasm.padding_left(img.ptr, padding, ptr0);
    return PhotonImage.__wrap(ret);
};
...
__exports.padding_right = function(img, padding, padding_rgba) {
    ...
    var ptr0 = padding_rgba.ptr;
    padding_rgba.ptr = 0;
    const ret = wasm.padding_right(img.ptr, padding, ptr0);
    return PhotonImage.__wrap(ret);
};
...
__exports.padding_top = function(img, padding, padding_rgba) {
    ...
    var ptr0 = padding_rgba.ptr;
    padding_rgba.ptr = 0;
    const ret = wasm.padding_top(img.ptr, padding, ptr0);
    return PhotonImage.__wrap(ret);
};
...
__exports.padding_bottom = function(img, padding, padding_rgba) {
    ...
    var ptr0 = padding_rgba.ptr;
    padding_rgba.ptr = 0;
    const ret = wasm.padding_bottom(img.ptr, padding, ptr0);
    return PhotonImage.__wrap(ret);
};
...
class Rgb {
    ...
    */
    get_red() {
        const ret = wasm.rgb_get_red(this.ptr);
        return ret;
    }
    /**
    * Get the Green value.
    ...
    */
    get_green() {
        const ret = wasm.rgb_get_green(this.ptr);
        return ret;
    }
    /**
    * Get the Blue value.
    ...
    */
    get_blue() {
        const ret = wasm.rgb_get_blue(this.ptr);
        return ret;
    }
}
__exports.Rgb = Rgb;
...
class Rgba {
    ...
    */
    get_red() {
        const ret = wasm.rgba_get_red(this.ptr);
        return ret;
    }
    /**
    * Get the Green value.
    ...
    */
    get_green() {
        const ret = wasm.rgba_get_green(this.ptr);
        return ret;
    }
    /**
    * Get the Blue value.
    ...
    */
    get_blue() {
        const ret = wasm.rgba_get_blue(this.ptr);
        return ret;
    }
    /**
    ...
    */
    get_alpha() {
        const ret = wasm.rgba_get_alpha(this.ptr);
        return ret;
    }
}
__exports.Rgba = Rgba;
...
class Spell {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Spell.prototype);
        obj.ptr = ptr;
    ...
    */
    constructor(name, damage) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.spell_new(ptr0, len0, damage);
        return Spell.__wrap(ret);
    }
}
__exports.Spell = Spell;
/**
*/
class Wizard {

    static __wrap(ptr) {
        const obj = Object.create(Wizard.prototype);
        obj.ptr = ptr;
    ...
    */
    constructor(name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wizard_new(ptr0, len0);
        return Wizard.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    cast_spell() {
        const ret = wasm.wizard_cast_spell(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {any}
    */
    get_spells() {
        const ret = wasm.wizard_get_spells(this.ptr);
        return takeObject(ret);
    }
}
__exports.Wizard = Wizard;
