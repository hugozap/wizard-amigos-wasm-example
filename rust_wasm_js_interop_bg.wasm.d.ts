...
export function add_effect(a: number, b: number, c: number, d: number, e: number): void;
export function main(): void;
export function __wbg_wizard_free(a: number): void;
export function __wbg_spell_free(a: number): void;
export function spell_new(a: number, b: number, c: number): number;
export function wizard_new(a: number, b: number): number;
export function wizard_cast_spell(a: number): number;
export function wizard_get_spells(a: number): number;
